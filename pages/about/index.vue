<template>
  <div class="container work-page pb-10">
    ...
    <div class="mt-4 print:block">
      ...
      <div>
        Technologist, Mauritian, who loves programming, UX design, Linux, &amp; nature.
      </div>
      <div class="py-10 text-lg lg:flex space-x-10 leading-loose">
        <div>
          <p class="font-bold">Passionate front-end developer based in Mauritius.</p>
          <p>In my free time I teach, contribute to open source and write on my blog.</p>
          <p>
            I keep up with the industry trends and help to level up my team whenever
            necesary.
          </p>
          <p>Working in the web development sphere for a decade and counting.</p>
        </div>

        <div class="text-sm">
          <div>
            <span class="uppercase text-xs">email: &nbsp;</span>sandeep@ramgolam.com
          </div>
          <div>
            <span class="uppercase text-xs">website:&nbsp;</span>https://sandeep.ramgolam.com
          </div>
          <div>
            <span class="uppercase text-xs">github:&nbsp;</span>https://github.com/MrSunshyne
          </div>
    ...
    <div class="block md:flex flex-col flex-wrap justify-center sm:justify-start my-4">
      <div class="dark:text-gray-500">
        <div
             class="pt-5 block print:flex md:flex items-center"
             v-for="item in stack"
             :key="item.title">
          <div class="font-bold tracking-widest pr-4 w-40">{{ item.title }}</div>
          <div
    ...
    <div class="flex flex-col flex-wrap justify-center sm:justify-start my-4">
      <div class="pb-5" v-for="project in projects" :key="project.name">
        ...
        <div class="hidden print:flex sm:flex items-center text-gray-800">
          <div class="hidden print:inline uppercase text-xs pr-2">Tech Stack :</div>
          <div
