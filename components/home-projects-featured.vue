    ...
    <div class="project-container mx-auto">
      ...
      <div v-if="projects" class="projects-wrapper">
        <template v-for="(project, index) in projects" :key="'project' + index">
          <div v-if="project.featured" class="project-card" data-aos="fade-left">
            <div class="project-content">
              <!-- SVG clip path definition for organic image shape -->
              <svg class="absolute w-0 h-0" aria-hidden="true">
                <defs>
                  <clipPath :id="`project-clip-${index}`" clipPathUnits="objectBoundingBox">
              ...
              <div class="image-container" :style="`clip-path: url(#project-clip-${index})`">
                <img
