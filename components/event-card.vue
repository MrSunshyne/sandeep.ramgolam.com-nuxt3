<template>
  <div
    ...
    <h2 class="text-xl lg:text-2xl font-bold pb-4 tracking-tight">{{ event.topic }}</h2>
    ...
    <div>
      <a :href="link.url"
         ...
         class="text-sm underline flex hover:text-green-500 text-gray-700 dark:text-gray-400" target="_blank"
