...
<template>
    <div class="fixed top-[64px] w-full h-[1px] justify-center items-start hidden md:flex z-10">
        <svg width="100%" height="12" viewBox="0 0 1501 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="py-3 sm:py-8 sticky h-[128px] lg:top-[-32px] z-10 menu-outer-wrapper ">
...
.menu-outer-wrapper {
    background: linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, #FFFFFF 30%, #FFFFFF 75%, #FFFFFF 76%, rgba(255, 255, 255, 0) 95%, rgba(255, 255, 255, 0) 100%);
}
